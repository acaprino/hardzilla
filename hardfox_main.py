...
class HardfoxApp:
    ...
    def __init__(self):
        ...
        logger.info("Initializing Hardfox v4.0...")
        ...
        logger.info("[OK] Hardfox v4.0 initialized successfully")
    ...
    def run_cli_demo(self):
        ...
        """
        print("\n" + "="*60)
        print("  Hardfox v4.0 - Firefox Hardening Tool")
        ...
        print("2. Run: python hardfox_main.py --apply <firefox_profile_path>")
        print()
...
def main():
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "--apply" and len(sys.argv) >= 4:
            ...
            print("\nUsage:")
            print("  python hardfox_main.py              Run demo")
            print("  python hardfox_main.py --apply <firefox_path> <profile_name>")
            print("  python hardfox_main.py --help       Show this help")
            print()
        else:
