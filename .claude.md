# Hardzilla v4.0 - Firefox Privacy & Security Configurator
...
- **Views:** UI rendering only (`hardzilla/presentation/views/`)
- **ViewModels:** Observable state, no UI logic (`hardzilla/presentation/view_models/`)
- **Controllers:** Wire views to use cases (`hardzilla/presentation/controllers/`)
- **Why:** Decouples UI from business logic, enables testing without GUI

### 2. Repository Pattern
- **Interfaces:** `hardzilla/domain/repositories/` (abstract)
- **Implementations:** `hardzilla/infrastructure/persistence/` (concrete)
...
### 3. Use Case Pattern
- **Location:** `hardzilla/application/use_cases/`
...
- **Composition Root:** `hardzilla_gui.py` (GUI), `hardzilla_main.py` (CLI)
...
**Hardzilla v4:** User answers 3 questions, IntentAnalyzer generates optimal config
...
**Location:** `hardzilla/application/services/intent_analyzer.py`
...
### Entry Points
- **`hardzilla_gui.py`** - GUI application (3-screen wizard, MVVM wiring)
- **`hardzilla_main.py`** - CLI demo (dependency injection composition root)
- **`launch_hardzilla.bat`** - Windows launcher with dependency checks

### Metadata (Source of Truth)
- **`hardzilla/metadata/settings_metadata.py`** - All 78+ settings definitions
...
### Domain Model
- **`hardzilla/domain/entities/setting.py`** - Setting entity (validation, Firefox pref conversion)
- **`hardzilla/domain/entities/profile.py`** - Profile entity (collection of settings)
- **`hardzilla/domain/enums/setting_level.py`** - BASE (user-editable) vs ADVANCED (locked)

### Core Services
- **`hardzilla/application/services/intent_analyzer.py`** - Intent → Config engine
- **`hardzilla/infrastructure/parsers/prefs_parser.py`** - Robust Firefox prefs.js parser
- **`hardzilla/infrastructure/persistence/firefox_file_repository.py`** - Firefox file I/O

### UI Layer
- **`hardzilla/presentation/views/setup_view.py`** - Screen 1 (Intent questions)
- **`hardzilla/presentation/views/customize_view.py`** - Screen 2 (78+ settings browser)
- **`hardzilla/presentation/views/apply_view.py`** - Screen 3 (Apply to Firefox)
- **`hardzilla/presentation/widgets/setting_row.py`** - Individual setting control
- **`hardzilla/presentation/theme.py`** - Professional visual theme
...
- User can change: No (Hardzilla locks them)
...
1. **Edit Metadata**
   - File: `hardzilla/metadata/settings_metadata.py`
...
- **Parser:** `hardzilla/infrastructure/parsers/prefs_parser.py`
- **Repository:** `hardzilla/infrastructure/persistence/firefox_file_repository.py`
...
### Manual Testing
- **GUI Workflow:** Run `hardzilla_gui.py`, complete 3-screen wizard
